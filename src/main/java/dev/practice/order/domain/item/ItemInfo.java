...
public class ItemInfo {
    ...
    @Getter
    @ToString
    public static class Main { // 예시: 스웨터
    ...
    @Getter
    @ToString
    public static class ItemOptionGroupInfo { // 예시: 색상
    ...
    @Getter
    @ToString
    public static class ItemOptionInfo { // 예시: 빨강, 초록
        private final Integer ordering;
        private final String itemOptionName;
        private final Long itemOptionPrice; // 옵션변경에 따른 가격 추가
